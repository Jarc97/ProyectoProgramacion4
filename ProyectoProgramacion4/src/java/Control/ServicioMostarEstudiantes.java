 ...
 * @author Feli
 */
@WebServlet(name = "ServicioMostrarEstudiantes", urlPatterns = "/ServicioMostrarEstudiantes")
public class ServicioMostarEstudiantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                request.setAttribute("listaE", ge.obtenerEstudiantesActivos(opc));
    ...
    public String listaProductosJSON() {
        try {
            ...
            List<Estudiante> estudiantes = g.listarEstudiantes();
